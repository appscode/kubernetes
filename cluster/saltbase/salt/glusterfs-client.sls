...
glusterfs-pkgrepo:
  pkgrepo.managed:
    ...
    - name: deb http://download.gluster.org/pub/gluster/glusterfs/3.10/LATEST/Debian/jessie/apt jessie main
    - dist: jessie
    - file: /etc/apt/sources.list.d/gluster.list
    - key_url: https://download.gluster.org/pub/gluster/glusterfs/3.10/rsa.pub
glusterfs-client:
  pkg.latest:
    - refresh: True
    - require:
